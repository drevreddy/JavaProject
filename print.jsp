...
<caption> 	Boarding Pass  </caption>
<%
while(rs1.next())
{
%>
<tr>
  <th> Customer Name </th> <td> <%=rs1.getString(2)%> </td> 
	<th> Departure Date </th> <td> <%=dod %> </td>
</tr>

<tr>
  <th> From : </th>  <td> <%=fplace %> </td> <th> Return Date </th> <td> <%=dor%> </td>
</tr> 


<tr>
  <th> To : </th>  <td> <%=tplace %> </td><th> Depart Time </th> <td> <%=dtime %> </td>
...
<tr>
<th> Flight  </th> <td> <%=fid%> </td><th> Total Fare </th> <td> 8000 </td>
</tr>
...
<br><br>
<a href="javascript:window.print()">
<font face=arial size=3 color=gray>Print The Boarding Pass</font></a>
</center>
